...
class CSurface:
    ...
    @classmethod
    def from_surface(cls, surface:pygame.Surface, color:pygame.Color=pygame.Color(0,0,0), heigth:int=1):
        c_surf = cls(pygame.Vector2(0,0), color, heigth)
        c_surf.surf = surface
    ...
    def from_text(cls, text:str, font:pygame.font.Font, color:pygame.Color, heigth:int=1):
        ...
        return cls.from_surface(text_surface, color, heigth)
